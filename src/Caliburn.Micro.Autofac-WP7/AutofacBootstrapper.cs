...
namespace Caliburn.Micro.Autofac
{
  public class AutofacBootstrapper : PhoneBootstrapper
  {
    ...
    { //  allow base classes to change bootstrapper settings
      ...
      builder.Register<INavigationService>(c => new FrameAdapter(RootFrame)).InstancePerLifetimeScope();
      builder.Register<IPhoneService>(c => new PhoneApplicationServiceAdapter(PhoneService)).InstancePerLifetimeScope();
